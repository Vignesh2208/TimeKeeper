...
class SimpleLxcNode(PyCoreNode):
    def __init__(self, session, objid = None, name = None, nodedir = None,
                 verbose = False, start = True, dilation = None):
    ...
    def startup(self):
        ...
        print "Starting a new node with dilation: ", self.dilation
...
class LxcNode(SimpleLxcNode):
    def __init__(self, session, objid = None, name = None, dilation = None,
                 nodedir = None, bootsh = "boot.sh", verbose = False,
                 start = True):
        super(LxcNode, self).__init__(session = session, objid = objid, dilation = dilation,
